...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(jumpOtherParentsController:) name:@"jumpItem" object:nil];
    //初始化两个视图控制器
...
#pragma mark -- 跳转到tabBarController另外一个Item 父级控制器
-(void)jumpOtherParentsController:(NSNotification *)notice{

    //这句话就是重点 tabBarController提供的一个方法,指定控制器
